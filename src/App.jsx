...
const GAMES = [
    ...
    data:{
      ...
      medium:{
        groups:[
          ...
          { name:"Nidhi's words for him 💜", color:"#f59e0b",
            items:["Incredible","Sweetest","Caring","Perfect"] },
      ...
      hard:{
        groups:[
          ...
          { name:"Feelings she wrote about 🥹", color:"#f59e0b",
            items:["Heart racing","Melted","Didn't want him to leave","Hoped again"] },
          { name:"Nidhi's poem lines 🌿", color:"#10b981",
            items:["Tale of youth","What was to come","Roller coaster","Memories they'd wear"] },
        ],
      },
    },
  },
  // 3 — TRIVIA (How Well Do You Know Him) 10am
  // Topic: facts about Krish — school, work, personality. No story overlap with game 14.
  {
    id:3, type:"trivia", emoji:"🧠", title:"How Well Do You Know Him?",
    unlockLabel:"10:00 AM",
    teaser:"Facts about him. Real ones.",
    howToPlay:[
    ...
    data:{
      easy:[
        { q:"What is Krish's major?", options:["CS","ECE","Mech E","Finance"], a:1 },
        { q:"What university does Krish attend?", options:["UT Austin","Rice","Texas A&M","UH"], a:2 },
        { q:"What does Krish do for work?", options:["Barista","Full-time dev","AI Engineer","Intern"], a:2 },
        { q:"What dance team did they both join?", options:["Raas","Fusion","Naacho","Bhangra"], a:2 },
        { q:"What company is Krish interning at?", options:["SpaceX","Lockheed","Apple","Boeing"], a:3 },
      ],
      medium:[
        { q:"What state is Krish's internship in?", options:["Texas","California","Missouri","Ohio"], a:2 },
        { q:"What programming language does Krish use most?", options:["Python","Java","JavaScript","C++"], a:2 },
        { q:"What is Krish's AI project at work called?", options:["VeloEngine","ChaiBot","LangFlow","Velostics Engine"], a:3 },
        { q:"What AI framework does Krish build agents with?", options:["TensorFlow","LangChain","PyTorch","Keras"], a:1 },
        { q:"What TAMU team did Krish apply to?", options:["Robotics Club","FSAE","All of them","Sounding Rocketry"], a:3 },
      ],
      hard:[
        { q:"What is Krish's PCB project called?", options:["RADBOT","NUKE","ATOM","IDRON"], a:3 },
        { q:"What hardware has Krish built with?", options:["Arduino only","FPGA only","ESP32 & Raspberry Pi","None"], a:2 },
        { q:"What was Krish's go-to Game Pigeon game?", options:["Chess","Basketball","Anagram","8-ball"], a:3 },
        { q:"What was Krish's previous university before Texas A&M?", options:["UT Austin","UH","Rice","SMU"], a:2 },
        { q:"What is Krish's favorite film genre?", options:["Horror","Rom-com","Action","Sci-fi"], a:3 },
      ],
    },
  },
  ...
  // Topic: specific moments/places from their story. No overlap with other games.
  {
    ...
    data:{
      ...
      medium:[
        { emojis:"💜😊✅",   answerHash:H("CONFESSION"),    hint:"Mar 19, 2022 — the best day" },
        { emojis:"💃🎶✨🎭", answerHash:H("DIL SE NAACH"),  hint:"Their second show together" },
        { emojis:"🎄🩺💔💜", answerHash:H("URBAN NUTCRACKER"), hint:"The last show, and almost the last time" },
      ],
      hard:[
        { emojis:"🌲😳💕",     answerHash:H("HE WAS SO TALL"),   hint:"Her first thought seeing him IRL" },
        { emojis:"😊🌸📝💌",   answerHash:H("NOTES"),             hint:"What they used to write each other every day" },
        { emojis:"🏠🛌🚶💕",   answerHash:H("HER HOUSE"),        hint:"First official time hanging out outside Naacho" },
      ],
    },
  },
  // 5 — MEMORY MATCH 12pm
  ...
  // Topic: meaningful words from their story — different words from all other games
  {
    ...
    data:{
      ...
      medium:[
        { scrambled:"TGEERTHO",      answerHash:H("TOGETHER"),    clue:"Where you always end up" },
        { scrambled:"YRANNISREVA",   answerHash:H("ANNIVERSARY"), clue:"What today is 🎉" },
        { scrambled:"TNURAMECK",     answerHash:H("NUTCRACKER"),  clue:"Their last show 🎄" },
      ],
      hard:[
  ...
  // Topic: real events in order — distinct from all other games
  {
    ...
    data:{
      ...
      medium:{ events:[
        { text:"Discord — geometry convos" },
        { text:"Flirty arguments begin 😊" },
        { text:"His mom's famous quote 😭" },
        { text:"Joined Naacho 💃" },
        { text:"Confession & official" },
        { text:"Hangout at her house 🏠" },
        { text:"Beaumont show 🎭" },
        { text:"Carnival day 🎡" },
      ]},
      hard:{ events:[
        { text:"Jan 18 2022 — Discord convo" },
        { text:"First IRL — robotics comp" },
        { text:"Feb 21 2022 — flirty convos" },
        { text:"Feb 27 2022 — his mom's quote" },
        { text:"Mar 19 2022 — confession" },
        { text:"Made it official" },
        { text:"Joined Naacho" },
        { text:"Her house hangout" },
        { text:"Cancun 🌴" },
        { text:"Beaumont show + bus ride" },
        { text:"Carnival day" },
        { text:"The play at her school" },
        { text:"Dil Se Naach" },
        { text:"Urban Nutcracker" },
        { text:"Hoco — junior year" },
      ]},
    },
  },
  // 10 — WORD SEARCH 5pm
  // Topic: adjectives/words Nidhi used to describe Krish — only place they appear
  {
    ...
    data:{
      ...
      medium:{ words:["FUNNY","BRAVE","YOURS","SMILE","LOYAL"],  gridSize:11 },
      hard:  { words:["ELECTRIC","MAGNETIC","RADIANT","WONDER","FOREVER"], gridSize:13 },
    },
  },
  ...
  // Topic: his genuine preferences — different angles from trivia game
  {
    ...
    data:{
      ...
      medium:[
        { q:"Would Krish rather…", a:"Win an argument with her", b:"Make her laugh", answer:1 },
        { q:"Would Krish rather…", a:"Re-live the Beaumont bus ride", b:"Re-live Cancun", answer:1 },
        { q:"Would Krish rather…", a:"Cook dinner for her", b:"Order her favorite food", answer:1 },
        { q:"Would Krish rather…", a:"Be the one to confess", b:"Wait for her to confess", answer:0 },
      ],
      hard:[
        { q:"Would Krish rather…", a:"Go back to Jan 18 2022", b:"Fast forward 10 years", answer:1 },
        { q:"Would Krish rather…", a:"Forget and start over", b:"Remember every single moment", answer:1 },
        { q:"Would Krish rather…", a:"A life without any hard times", b:"Every hard time, but with her", answer:1 },
        { q:"Would Krish rather…", a:"Build rockets for a living", b:"Build a life with her", answer:1 },
        { q:"Would Krish rather…", a:"Win every Game Pigeon game", b:"Make her smile every day", answer:1 },
      ],
    },
  },
  // 12 — CAPTION GAME 7pm
  // Topic: specific scenes from their story — distinct captions, distinct scenes
  {
    ...
    data:{
      easy:[{
        scene:"📸 A blurry photo of us laughing at 2am after Naacho practice",
        options:["Certified night owls 🦉","She said something unhinged again 😭","Main characters only 💅","idk we look cute"],
        answer:1,
      }],
      medium:[{
        scene:"📸 A candid of us on the beach in Cancun — she doesn't know I took it",
        options:["paradise 🌴","she finally let me take a pic lol","idk she wanted a pic","we actually did this 🥹"],
        answer:1,
      }],
      hard:[{
        scene:"📸 Me looking at her when she doesn't notice — she's laughing at something else",
        options:["Candid 📷","ok this one is cute ngl","You're it for me.","She has no idea 💜"],
        answer:2,
      }],
    },
  },
  ...
  // Topic: exact quotes, exact details, fine-grain facts — zero overlap with game 3
  {
    ...
    data:{
      easy:[
        { q:"How did Nidhi say she'd reach his height?",
          options:["Get a stepladder","Wear 2ft heels or have Hasini carry her","Ask him to sit down","Stand on a chair"], a:1 },
        { q:"What was Ria's role in them getting together?",
          options:["She set them up on a date","She was just blunt and gave the push","She left them alone","She told Nidhi to give up"], a:1 },
        { q:"What did Nidhi write in her note on the day they got together?",
          options:["I love you so much","I was so unsure but now I know it's the best decision I've ever made","You're my favorite person","So happy right now"], a:1 },
        { q:"What did Nidhi say about Krish's hugs in the Dil Se Naach section?",
          options:["Best hugs ever","They fit together perfectly","So warm and cozy","She could hug him forever"], a:1 },
        { q:"What did Nidhi say should be illegal?",
          options:["Being so in love","Feeling the way he makes her feel","Being this happy","Being this lucky"], a:1 },
      ],
      medium:[
        { q:"Complete his flirty line: 'If I'm amazing then you're something that…'",
          options:["No word can describe","Stars envy","Dreams are made of","I'll never forget"], a:0 },
        { q:"At Cancun, Nidhi said every moment was better than ___",
          options:["amazing","anything","expected","perfect"], a:3 },
        { q:"Which friend carried Nidhi so she could see the robots at the competition?",
          options:["Ria","Priya","Hasini","Asha"], a:2 },
        { q:"What happened to Nidhi at Urban Nutcracker?",
          options:["She forgot her part","She popped her shoulder","She was late","She missed the bus"], a:1 },
        { q:"What did Nidhi say Krish's mom told him?",
          options:["She seems like a good girl","Why don't you just marry the girl","You really like her huh","Call her more often"], a:1 },
      ],
      hard:[
        { q:"On Jan 18, 2022, what exact time did the Discord convo start?",
          options:["9:00 PM","11:45 PM","10:30 PM","10:02 PM"], a:3 },
        { q:"Which geometry proof steps did Krish say he always got mixed up?",
          options:["7 and 8","Step 3 and 4","Step 11 and 12","Steps 9 and 10"], a:2 },
        { q:"What did Nidhi say she was thinking right before the confession?",
          options:["She would've been okay","She had no idea what she would've done","She would've asked again","She would've moved on"], a:1 },
        { q:"How does Nidhi end the Year 1 scrapbook?",
          options:["Our story forever","Just the beginning","A fairytale","Our everything"], a:1 },
        { q:"On Feb 27 2022, what did Krish say his mom told him?",
          options:["Call her more","She seems shy","She's so pretty","Why don't you just marry the girl"], a:3 },
      ],
    },
  },
  // 15 — FINAL 10pm
