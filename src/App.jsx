...
const GAMES = [
  ...
  // Topic: real events in order — distinct from all other games
  {
    ...
    data:{
      ...
      medium:{ events:[
        { text:"Confession & made it official 💜" },
        { text:"Cancun 🌴" },
        { text:"Joined Naacho 💃" },
        { text:"Senior year together 🎓" },
        { text:"Prom — green 💚" },
        { text:"Sept 24 2024 — Hoco at Rice (purple) 💜" },
        { text:"Miller Outdoor Theatre 🌟" },
        { text:"Sept 20–21 2025 — first college visit" },
      ]},
      hard:{ events:[
  ...
  // Topic: adjectives/words Nidhi used to describe Krish — only place they appear
  {
    ...
    data:{
      ...
      medium:{ words:["GARBA","PURPLE","VELVET","BOWLING","TATSUYA"],  gridSize:11 },
      hard:  { words:["JHALAK","KROGER","MICKEY","NORTH","PENN","DHOOMA"], gridSize:13 },
    },
  },
  ...
  // Topic: specific scenes from their story — distinct captions, distinct scenes
  {
    ...
    data:{
      easy:[{
        scene:"📸 Us at Miller Outdoor Theatre — starry background, pre-grad (his favorite pic)",
        options:["main characters only ✨","this one stays forever 🌟","we ate good after this","idk we look cute"],
        answer:1,
      }],
      medium:[{
        scene:"📸 Hoco Sept 24, 2024 — purple fits, photos at Rice",
        options:["purple looks good on us 💜","rice campus hits different","hoco but make it us","certified rice photogs"],
        answer:0,
      }],
      hard:[{
  ...
  // Topic: exact quotes, exact details, fine-grain facts — zero overlap with game 3
  {
    ...
    data:{
      easy:[
        ...
        { q:"Where did you take Hoco photos that day?",
          options:["Downtown Houston","Rice campus","The Kroger lot","Miller Outdoor Theatre"], a:1 },
        { q:"What was your prom color?",
          options:["Purple","Green","Blue","Black & white"], a:1 },
